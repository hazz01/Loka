...
class FinishScreenLoginPageManager extends StatefulWidget {
  const FinishScreenLoginPageManager({super.key});

  @override
  State<FinishScreenLoginPageManager> createState() =>
      _FinishScreenLoginPageManagerState();
}

class _FinishScreenLoginPageManagerState
    extends State<FinishScreenLoginPageManager> {
  @override
  void initState() {
    super.initState();
