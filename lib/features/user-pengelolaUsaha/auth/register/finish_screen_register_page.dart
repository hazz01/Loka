...
class FinishScreenRegisterPage extends StatefulWidget {
  const FinishScreenRegisterPage({super.key});

  @override
  State<FinishScreenRegisterPage> createState() =>
      _FinishScreenRegisterPageState();
}

class _FinishScreenRegisterPageState extends State<FinishScreenRegisterPage> {
  @override
  void initState() {
    super.initState();
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Everything is ready. Let's start growing\nyour tourism business.",
                        style: TextStyle(
